...
Evaluates trained RetinaNet model on test set and reports metrics
"""
...
def main(coco_root_dir="./coco_droneRGBT", modality="rgb", checkpoint_path=None, score_threshold=0.5,
    ...
    if not os.path.exists(checkpoint_path):
        ...
        print(f"  python coco_finetune_fcos.py --modality {modality}")
        return
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate Detectron2 RetinaNet model on COCO format test dataset")
